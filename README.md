...
### Como Rodar 💻❓:
Primeiramente, certifique-se de ter o Python Istalado na sua máquina (Versão 3.8 ou superior recomendada). [Clique aqui](https://www.python.org/downloads/release/python-3142/) para fazer o donwload da versão mais recente do Python. Feito a instalação verifique se o Python está funcionando corretamente, para isso, execute o comando `Python` no seu terminal, como resposta deverá ser exibido algo semelhante ao bloco de código a seguir:
```
...
INTEGRANTES:
1. Ângelo Vinicius Meireles Ferreira;
2. Carlos Daniel Silva Barbosa;
